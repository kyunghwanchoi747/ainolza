...
import { User, Package, FileText, MessageCircle, Settings, CreditCard, Bookmark, LogOut } from 'lucide-react'
        ...
        <div className="flex flex-col gap-10 lg:flex-row">
          ...
          <aside className="w-full lg:w-80 space-y-6">
            <div className="rounded-[2.5rem] border border-white/10 bg-white/5 p-8 text-center shadow-2xl relative overflow-hidden">
              ...
              <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mt-1">BASIC MEMBER</p>
          ...
          <main className="flex-grow space-y-8">
            ...
            <div className="rounded-[3rem] border border-white/10 bg-white/5 p-10 shadow-2xl">
              <div className="flex items-center justify-between mb-10">
                <h3 className="text-xl font-black text-white uppercase tracking-tight">최근 수강 중인 강의</h3>
                <button className="text-xs font-bold text-blue-400 hover:underline">전체보기</button>
              </div>
              <div className="flex flex-col items-center justify-center py-20 text-center text-gray-600">
                <div className="h-20 w-20 rounded-full bg-white/5 flex items-center justify-center mb-6">
                  <Bookmark className="h-8 w-8 opacity-20" />
                </div>
                <p className="text-sm font-bold uppercase tracking-widest">수강 중인 강의가 없습니다.</p>
                <Link href="/courses" className="mt-4 text-xs font-bold text-blue-400 border border-blue-400/30 px-6 py-2 rounded-full hover:bg-blue-400/10">추천 강의 보러가기</Link>
              </div>
            </div>
          </main>
        </div>

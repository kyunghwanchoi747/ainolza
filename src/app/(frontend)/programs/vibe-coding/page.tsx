    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <section className="pt-24 pb-16 px-6 border-b border-foreground/10">
        <div className="max-w-3xl mx-auto">
          <Link href="/programs" className="text-sm text-foreground/40 hover:text-foreground transition-colors mb-6 inline-block">
            &larr; 프로그램 목록
          </Link>
          ...
          <p className="text-foreground/50 text-lg mb-8">나만의 독립된 웹사이트를 AI로 직접 만드는 실전 과정</p>
          <div className="flex flex-wrap gap-4 items-center">
            <Link
              href="/programs/vibe-coding/enroll"
              className="inline-block px-8 py-4 bg-foreground text-background font-bold rounded-xl hover:scale-105 transition-all text-sm"
            >
              수강 신청하기
            </Link>
            <span className="text-foreground/30 text-sm">4주 과정 | 온라인</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto space-y-20">
          ...
          <div>
            ...
            <div className="space-y-8">
              {[
                { title: '시니어를 위한 AI', desc: '경험은 많지만 기술이 두려웠던 분들에게 AI는 최고의 플레이어가 됩니다.' },
                { title: '기획만 하세요', desc: '파이썬, 자바스크립트 몰라도 됩니다. AI가 뼈대를 잡고 정보를 수집합니다.' },
                { title: '강력한 무기', desc: '단순히 AI 쓰는 법이 아니라, 실제 돈이 되는 웹을 만드는 디렉팅 기술을 배웁니다.' },
              ].map((item, i) => (
          ...
          <div>
            ...
            <div className="grid gap-4">
              {[
                { tag: '01', title: '관점의 전환', desc: '소비자의 눈이 아닌 생산자의 눈으로 시장(수요) 읽기.' },
                { tag: '02', title: '틈새 전략', desc: '대형 매체가 다루지 않는 지역 정보로 꾸준한 트래픽 만들기.' },
                { tag: '03', title: '바이브 코딩 실전', desc: 'AI로 독립 웹사이트 구축 및 커스터마이징.' },
                { tag: '04', title: '수익 자동화', desc: '구글 애드센스 연동 및 실질적인 현금 흐름 창출.' },
              ].map((item, i) => (

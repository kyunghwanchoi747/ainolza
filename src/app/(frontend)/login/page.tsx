    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-20">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-ink mt-4">로그인</h1>
        ...
        <div className="space-y-2 mb-6">
          ...
          <a
            ...
            className="w-full py-3 border border-line rounded-xl text-ink font-medium hover:bg-surface transition-all flex items-center justify-center gap-3"
          >
          ...
          <a
            href="/api/auth/naver"
            className="w-full py-3 bg-[#03C75A] rounded-xl text-white font-medium hover:bg-[#02b350] transition-all flex items-center justify-center gap-3"
          >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs"><span className="bg-white px-2 text-sub">또는</span></div>
        </div>

        ...
        <div className="container relative z-10 mx-auto text-center">
          ...
          >
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg text-gray-400 sm:text-xl">
              비전공자와 3060 세대를 위한 가장 쉬운 AI 실무 커뮤니티. 
              최신 AI 트렌드부터 강의, 커뮤니티까지 한곳에서 경험하세요.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            {[
              {
                title: '실무 중심 강의',
                desc: '현업에서 바로 쓰이는 실전 AI 활용법을 배웁니다.',
                icon: Play,
                color: 'bg-blue-500',
              },
              {
                title: '열린 커뮤니티',
                desc: '서로 돕고 성장하는 따뜻한 AI 소통 공간입니다.',
                icon: Zap,
                color: 'bg-purple-500',
              },
              {
                title: '검증된 리소스',
                desc: '엄선된 AI 도구와 자료를 큐레이션하여 제공합니다.',
                icon: Shield,
                color: 'bg-green-500',
              },
            ].map((feature, i) => (
        ...
        <div className="container mx-auto px-6">
          <div className="rounded-[3rem] bg-gradient-to-r from-blue-600 to-purple-600 p-12 text-center md:p-20">
            <h2 className="text-4xl font-black text-white md:text-5xl">
              지금 바로 AI 전문가로 <br className="md:hidden" /> 거듭나세요
            </h2>
            <p className="mt-6 text-lg text-white/80">
              망설이는 매 순간 기술은 앞서나갑니다. <br />
              AI 놀자와 함께라면 두렵지 않습니다.
            </p>
            <Link
              href="/login"

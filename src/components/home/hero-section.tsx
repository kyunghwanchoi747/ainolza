...
export function HeroSection() {
    const headline = "AI 시대, 당신은 '사용자'입니까, '디렉터'입니까?";
    const subhead = "Chat GPT 출시 5일차부터 시작된 3년의 기록. 《불편한 AI》 저자 최경환이 전하는 '생존을 넘어선 지휘'의 기술.";
    ...
    return (
        <section className="relative overflow-hidden py-24 md:py-32 bg-background">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-6xl -z-10 pointer-events-none opacity-20 dark:opacity-10">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 blur-[100px] rounded-full mix-blend-multiply filter opacity-50" />
            </div>
        </section>
    );
}

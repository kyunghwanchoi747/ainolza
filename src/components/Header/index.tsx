...
import { Menu, X, Rocket, User, ShoppingBag, BookOpen, MessageSquare, HelpCircle } from 'lucide-react'
  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? 'border-b border-white/10 bg-black/80 backdrop-blur-md py-3' : 'bg-transparent py-5',
      )}
    >
      <div className="container mx-auto flex items-center justify-between px-6">
        ...
        <Link href="/" className="flex items-center space-x-3 group">
          <BrandLogo />
          <span className="text-xl font-bold tracking-tight text-white group-hover:text-blue-400 transition-colors">AI 놀자</span>
        </Link>

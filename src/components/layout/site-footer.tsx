...
회사는 서비스 제공을 위해 다음과 같은 외부 서비스를 이용하며, 이에 따라 개인정보가 처리될 수 있습니다.

1. Cloudflare (미국): 웹사이트 호스팅 및 보안 서비스. 접속 IP, 브라우저 정보 등이 처리됩니다.
2. Google Gemini API: AI 실험실 서비스 제공. 사용자가 입력한 텍스트가 AI 처리를 위해 전송됩니다. 개인정보는 포함하지 않습니다.
3. 결제 대행사 (추후 안내): 결제 처리를 위해 결제 정보가 PG사에 전달됩니다.

제6조 (쿠키의 사용)

회사는 로그인 유지 및 서비스 개선을 위해 쿠키를 사용합니다. 사용자는 브라우저 설정을 통해 쿠키 저장을 거부할 수 있으나, 일부 서비스 이용이 제한될 수 있습니다.

제7조 (개인정보 보호책임자)

성명: 최경환
연락처: ainolza@naver.com

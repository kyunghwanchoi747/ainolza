...
export function Header() {
    ...
    return (
        <header className="fixed top-0 w-full z-[100] border-b border-white/5 bg-[#050505]/80 dark:bg-[#050505]/80 backdrop-blur-xl">
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 text-[13px] font-medium text-foreground/60">
                    <Link href="/programs" className="hover:text-foreground transition-colors">프로그램</Link>
                    <Link href="/community" className="hover:text-foreground transition-colors">커뮤니티</Link>
                    <Link href="/store" className="hover:text-foreground transition-colors">스토어</Link>
            ...
            {/* 모바일 메뉴 */}
            {isOpen && (
                <div className="md:hidden border-t border-white/5 bg-[#050505] dark:bg-[#050505] px-6 py-4 flex flex-col gap-4">
                    <Link href="/programs" className="text-sm text-foreground/60 hover:text-foreground" onClick={() => setIsOpen(false)}>프로그램</Link>
                    <Link href="/community" className="text-sm text-foreground/60 hover:text-foreground" onClick={() => setIsOpen(false)}>커뮤니티</Link>
                    <Link href="/store" className="text-sm text-foreground/60 hover:text-foreground" onClick={() => setIsOpen(false)}>스토어</Link>
